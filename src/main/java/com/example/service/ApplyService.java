...
public interface ApplyService {
     ...
     * @return 页面封装数据
     */
    PageBean page(Integer page, Integer pageSize, LocalDateTime begin, LocalDateTime end, String year, Integer trimesters, List<Integer> courseIds, String university);
